...
export function PresentationNav() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-[100] flex items-center gap-2 bg-background/95 backdrop-blur-sm border border-border rounded-full px-3 py-2 shadow-lg">
      <Button
        variant="ghost"
        size="sm"
        onClick={handlePrev}
